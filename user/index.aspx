<%@ Page Title="" Language="C#" MasterPageFile="~/user/usersmaster.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="wtservice.user.index" %>
                ...
                <div class="shell text-center">
                    <div class="range">
                        <div class="cell-xs-12">
                            <h2>Services in Everyday Life</h2>
            ...
            <div class="section-top-40 section-bottom-60 section-sm-bottom-110">
                    ...
                    <div class="range">
                        <div data-arrows="true" data-loop="true" data-dots="false" data-swipe="true" data-items="1"
                            ...
                            <div class="item height-fill">
                                <div class="product">
                                    <a href="service_list.aspx.html#ice-maker-repair" class="product-image">
                                        <img src="images/auto_car.jpg" alt="" width="223" height="227" /></a>
                                    <div class="product-caption">
                                        <div class="divider divider-sm divider-primary"></div>
                                        <div class="product-title">
                                            <h5><a href="service_list.aspx#ice-maker-repair">Electrician Services</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item height-fill">
                                <div class="product">
                                    <a href="service_list.aspx#stove-repair" class="product-image">
                                        <img
                                            src="images/ac_services(223X227).jpg" alt="" width="223" height="227" /></a>
                                    <div class="product-caption">
                                        <div class="divider divider-sm divider-primary"></div>
                                        <div class="product-title">
                                            <h5><a href="service_list.aspx#stove-repair">AC Services</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item height-fill">
                                <div class="product">
                                    <a href="service_list.aspx#microwave-repair" class="product-image">
                                        <img
                                            src="images/auto-repair227.jpg" alt="" width="223" height="227" /></a>
                                    <div class="product-caption">
                                        <div class="divider divider-sm divider-primary"></div>
                                        <div class="product-title">
                                            <h5><a href="service_list.aspx#microwave-repair">Vehicle Repair</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item height-fill">
                                <div class="p'roduct">
                                    <a href="s'ervice_list.aspx#washer-repair" class="product-image">
                                        <img src="images/plumber227.jpg" alt="" width="223" height="227" /></a>
                                    <div class="product-caption">
                                        <div class="divider divider-sm divider-primary"></div>
                                        <div class="product-title">
                                            <h5><a href="service_list.aspx#washer-repair">Plumber</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item height-fill">
                                <div class="product">
                                    <a href="service_list.aspx#refrigerator-repair" class="product-image">
                                        <img
                                            src="images/haircut.png" alt="" width="223" height="227" /></a>
                                    <div class="product-caption">
                                        <div class="divider divider-sm divider-primary"></div>
                                        <div class="product-title">
                                            <h5><a href="service_list.aspx#refrigerator-repair">Salon and SPA</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item height-fill">
                                <div class="product">
                                    <a href="service_list.aspx#range-hood-repair" class="product-image">
                                        <img src="images/home-sanitize-2BDRRH5.jpg" alt="" width="223" height="227" /></a>
                                    <div class="product-caption">
                                        <div class="divider divider-sm divider-primary"></div>
                                        <div class="product-title">
                                            <h5><a href="service_list.aspx">Home Sanitization</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item height-fill">
                                <div class="product">
                                    <a href="service_list.aspx#range-hood-repair" class="product-image">
                                        <img src="images/realestate.png" alt="" width="223" height="227" /></a>
                                    <div class="product-caption">
                                        <div class="divider divider-sm divider-primary"></div>
                                        <div class="product-title">
                                            <h5><a href="service_list.aspx">RealEstate</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="shell offset-top-30 offset-sm-top-40">
                    <div class="text-center">
                        <a href="service_list.aspx" class="btn btn-primary min-width-230">view all services</a>
                    </div>
                </div>
            </div>
        </section>
